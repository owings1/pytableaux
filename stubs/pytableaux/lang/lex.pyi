...
class Quantified(Sentence, Sequence):
    ...
    @overload
    def __getitem__(self, i: Literal[0]|Literal[-3]) -> Quantifier: ...
    @overload
    def __getitem__(self, i: Literal[1]|Literal[-2]) -> Variable: ...
    @overload
    def __getitem__(self, i: Literal[2]|Literal[-1]) -> Sentence: ...
    @overload
