...
from pytableaux.proof import Rule, NodeKey
...
class Node(MapCover, abcs.Copyable):
    ...
    @overload
    def get(self, key: Literal['sentence', NodeKey.sentence]) -> Sentence|None: ...
    @overload
    def get(self, key: Literal['designated', NodeKey.designated]) -> bool|None:...
    @overload
    def get(self, key: str) -> Any:...
    @overload
    def __getitem__(self, key: Literal['sentence', NodeKey.sentence]) -> Sentence: ...
    @overload
    def __getitem__(self, key: Literal['designated', NodeKey.designated]) -> bool:...
    @overload
