...
from typing import (Any, ClassVar, Iterable, Literal, Mapping, Optional, Self,
...
from pytableaux.typing import _T, _LogicLookupKey, _RuleT, _TypeInstDict
...
class RulesRoot(Sequence[Rule]):
    ...
    def append(self, rule: type[Rule], /, *, name: Optional[str] = ...): ...
